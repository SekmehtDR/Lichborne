...
export const darkBase: ThemeVars = {
  ...
  '--compass-inactive-text':   '#666666',
  '--compass-inactive-bg':     '#181818',
  '--compass-inactive-border': '#303030',
  '--compass-center-text':     '#383838',
...
const darker: ThemeVars = {
  ...
  '--compass-inactive-bg':     '#111111',
  '--compass-inactive-border': '#282828',
  '--map-bg':            '#080605',
  '--map-chrome-bg':     '#0e0b05',
  '--map-border':        '#221808',
  '--map-border-subtle': '#181208',
  '--map-text':          '#a89060',
  '--map-text-muted':    '#4a3018',
  '--map-btn-bg':        '#181208',
...
const slate: ThemeVars = {
  ...
  '--compass-active-bg':       '#0d1d38',
  '--compass-active-border':   '#1f6feb',
  '--compass-active-glow':     'rgba(88, 166, 255, 0.35)',
  '--compass-inactive-bg':     '#161b22',
  '--compass-inactive-border': '#30363d',
  '--exit-text':       '#3fb950',
  '--exit-bg':         '#0d1a10',
  '--exit-border':     '#1e3a22',
...
const ivory: ThemeVars = {
  ...
  '--compass-inactive-bg':     '#f0f0f0',
  '--compass-inactive-border': '#d0d0d0',
...
const mist: ThemeVars = {
  ...
  '--compass-inactive-bg':     '#dde2e8',
  '--compass-inactive-border': '#c0c8d4',
...
const parchment: ThemeVars = {
  ...
  '--compass-inactive-bg':     '#e8e0d0',
  '--compass-inactive-border': '#c8b898',
...
const terminal: ThemeVars = {
  ...
  '--compass-active-bg':       '#001a08',
  '--compass-active-border':   '#00aa2a',
  '--compass-active-glow':     'rgba(0, 255, 65, 0.4)',
  '--compass-inactive-text':   '#005518',
  '--compass-inactive-bg':     '#020d02',
  '--compass-inactive-border': '#003810',
...
const cleric: ThemeVars = {
  ...
  '--compass-active-bg':     '#1c1800',
  '--compass-active-border': '#6a5000',
...
const empath: ThemeVars = {
  ...
  '--compass-active-bg':     '#0e2014',
  '--compass-active-border': '#388048',
...
const moonmage: ThemeVars = {
  ...
  '--compass-active-bg':       '#0c0e28',
  '--compass-active-border':   '#4040a0',
  '--compass-active-glow':     'rgba(120, 120, 216, 0.4)',
  '--compass-inactive-bg':     '#0c1020',
  '--compass-inactive-border': '#202858',
  '--exp-bar-bg': '#0c1020',
...
const paladin: ThemeVars = {
  ...
  '--compass-active-bg':     '#0e1430',
  '--compass-active-border': '#4858a8',
...
const ranger: ThemeVars = {
  ...
  '--compass-active-bg':       '#101800',
  '--compass-active-border':   '#3a5818',
...
const thief: ThemeVars = {
  ...
  '--compass-inactive-bg':     '#181820',
  '--compass-inactive-border': '#2c2c48',
  '--exp-bar-bg': '#161620',
